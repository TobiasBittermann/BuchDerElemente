...
- Die Aura beginnt mit einer Reichweite von **10 ft**.
- Alle **6 Sekunden** breitet sie sich um weitere **10 ft** aus.
- Die maximale Reichweite der Aura beträgt **60 ft**.

Jede Kreatur, die die Aura **zum ersten Mal betritt** oder ihren Zug **innerhalb der Aura beginnt**, muss einen **WIS Save** ablegen.
