# [Krone des vergessenen Königs](Krone%20des%20vergessenen%20Königs.md)
...
- Dein Charisma-Wert erhöht sich um **+2**.
- Dein maximales Charisma erhöht sich ebenfalls um **+2**.

Diese Boni können einen Charismawert von 20 überschreiten, jedoch niemals den neuen Maximalwert.
## Verwendung
Die Krone muss getragen werden und der Spieler der sie trägt muss attuned sein, um ihre magischen Eigenschaften zu entfalten.
## Aufladungen
Keine.
## Flüche (optional)
Keine.
## Geschichte & Legenden
Der Legende nach vereinte der ursprüngliche Träger ganze Königreiche allein durch seine Worte. Sein Schicksal ist unbekannt, doch seine Krone tauchte Jahrhunderte später auf dem Haupt eines untoten Herrschers tief unter der Erde wieder auf.
## Bekannte Besitzer
